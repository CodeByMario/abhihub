...
| ROUTE-104 | GET | `/prepair/<subject>` | — | `app.py` | 3770 | — | — | DEAD LINK |
| ROUTE-105 | GET | `/UHV` | — | `app.py` | 3777 | — | — | DEAD LINK |
| ROUTE-106 | GET | `/rank` | — | `app.py` | 3781 | — | — | DEAD LINK |
| ROUTE-107 | GET | `/show_rank` | — | `app.py` | 3799 | — | — | DEAD LINK |
| ROUTE-108 | POST | `/verify-file` | — | `app.py` | 3799 | — | — | DEAD LINK |
| ROUTE-109 | POST | `/get-file-url` | — | `app.py` | 3877 | — | — | DEAD LINK |
| ROUTE-110 | POST | `/update-file-metadata` | — | `app.py` | 3908 | — | — | DEAD LINK |
