...
## Commands
```bash
python dev/bots/run.py --list                 # show roster
python dev/bots/run.py --dry-run              # all bots, no network
python dev/bots/run.py --bot engagement       # one role
python dev/bots/run.py --cycle                # CEO runs everyone + weekly priority
```
