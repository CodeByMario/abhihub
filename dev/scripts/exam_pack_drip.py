...
Usage:
  # preview
  python dev/scripts/exam_pack_drip.py --segment dormant --dry-run
  # actually send (only after configuring a provider in .env)
  python dev/scripts/exam_pack_drip.py --segment dormant --send
  python dev/scripts/exam_pack_drip.py --csv exports/users_new.csv --send
